...
?>
    ...
    <?php
    	...
    	$headers = "from:onlinepaidserviesadmin@mymail.com";
    	 ...
    	 {
    	 	echo "Ur details are sent to petrolbunk <br>";
    	 	echo "u'll  recieve a call shortly from petrolbunk<br> ";
    	 	echo "u'll be charged as per the normal petrol coast+service charge <br>";
