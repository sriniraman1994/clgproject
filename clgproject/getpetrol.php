                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                          <div class="form-top">
                            <div class="form-top-left">
                              <h3>get petrtol</h3>
                                <p>Ente your location details</p>
                                 ...
                                 <div class="form-group" >
                                    ...
                                    <option value="kovai">kovai</option>
                                     ...
                                     <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label class="sr-only" for="form-first-name">name</label>
                                        <input type="text" name="location" placeholder=" location..." class="form-first-name form-control" id="form-first-name"required autofocus>
                                    </div>
...
if(mysql_query($sql)){
    ...
    $query = "select * from `admin`.`getpetrol` where state='$state' and district='$district'";
    ...
    while ($row = mysql_fetch_array($query_run))
    {
        ...
        echo "<center><table border=\"1\"><tr><td><b><a href=petrolsuccess.php>{$row['bunkname']}</a></b></td></tr><tr><td>{$row['phno']}</tr></td><tr><td>{$row['address']}</td></tr></table></center>";
        echo "<br />";
    }
}
}
