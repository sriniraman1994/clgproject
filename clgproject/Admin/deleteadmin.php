            ...
            <div class="inner-bg">
                ...
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-laptop"></i>deleteadmin</li>                          
                    </ol>
                </div>
            </div>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>enter the admin name to delete</h3>
                            		<p></p>
                                    <?php
...
if(isset($_POST['uname'])&&isset($_POST['passwd']))
{
    ...
    $pass2 = $_POST['passwd'];
    if($pass1 == $pass2){
    $sql = "delete from `admin`.`services` where uname='$uname'";
if(mysql_query($sql))
{
    echo '<p style="color:green">Admin deleted</p>:'.$uname;
 }
else {
                                ...
                                <form role="form" action="" method="post" class="registration-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="passwd" placeholder=" ur verification Password..." class="form-password form-control" id="form-password" required>
                                                                           ...
                                                                           <button type="submit" class="btn">Delete admin</button>
                                </form>
                            </div>
                        </div>
                    </div>
